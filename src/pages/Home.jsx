...
const Home = () => {
  ...
  return (
    <Container maxWidth={false} disableGutters sx={{ width: '100vw', padding: 0, margin: 0 }}>
      <Navbar handleLogout={handleLogout} handleLogoutAll={handleLogoutAll} user={user} getProviderIcon={getProviderIcon} />
      <Routes>
